      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="gradient-card shadow-card hover:shadow-warm transition-smooth border-0">
              <CardContent className="p-6">
                <div className={`w-12 h-12 gradient-hero rounded-lg ${isRTL ? 'ml-auto' : 'mr-auto'} mb-4 flex items-center justify-center`}>
